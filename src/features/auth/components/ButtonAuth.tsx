...
function ButtonAuth({ children, variant = "primary" }: Props) {
  const baseClasses = "px-40 py-3 w-full font-semibold rounded-sm text-2xl";
  const primaryClasses = "text-white bg-[#EF6B4A]";
  const secondaryClasses = "text-[#6251DD] border border-[#6251DD]";
